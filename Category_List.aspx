<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Category_List.aspx.cs" Inherits="Category_List" %>
        ...
        <div class="product-grid">
            <asp:Repeater ID="GridView1" runat="server">
                <ItemTemplate>
                    <div>
                        <div class="image">
                            <a href="subcategory_list.aspx?id=<%#Eval("code") %>">
                                <img src='<%#Eval("p_img") %>' alt="iPhone" height="135px" width="135px" /></a>
                        </div>
                        <div class="name"><a href="subcategory_list.aspx?id=<%#Eval("code") %>"><%#Eval("p_name") %></a></div>
                    </div>
                </ItemTemplate>
            </asp:Repeater>
        </div>
