...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <%--     <div class="product">
        ...
        <div class="product-filter">
            <div class="display"><b> <div class="breadcrumb" style="margin-bottom: 0;">
            <a style="color: #333333;  font-size: 12px;" href="Default.aspx">Online Store</a>  <a  style="color: #333333;  font-size: 12px;">»</a>  <a href="#" style="color: #333333;  font-size: 12px;">
                <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></a> <a  style="color: #333333;  font-size: 12px;">»</a>   <a href="#" style="color: #333333;  font-size: 12px;">
